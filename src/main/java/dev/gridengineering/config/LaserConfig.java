...
public final class LaserConfig {
    ...
    private static final Map<LaserTier, ModConfigSpec.LongValue> TIER_MAX_VOLTAGES =
    ...
    static {
        ...
        for (LaserTier tier : LaserTier.values()) {
            ...
            TIER_MAX_VOLTAGES.put(
                    tier,
                    builder.comment("Maximum voltage for " + tierId + ".")
                            .defineInRange(
                                    tierId + "MaxVoltage",
                                    defaultVoltages[tier.ordinal()],
                                    1,
                                    Long.MAX_VALUE
                            )
            );
    ...
    public static long tierMaxVoltage(LaserTier tier) {
        return TIER_MAX_VOLTAGES.get(tier).get();
    }
